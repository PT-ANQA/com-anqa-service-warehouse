...
//using Com.Anqa.Service.Purchasing.Lib.ViewModels.IntegrationViewModel;
//using Com.Anqa.Service.Purchasing.Lib.ViewModels.PurchaseOrder;
//using Com.Anqa.Service.Purchasing.Lib.ViewModels.UnitPaymentCorrectionNoteViewModel;
//using Com.Anqa.Service.Purchasing.Lib.ViewModels.UnitReceiptNote;
...
using System.Text;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentExternalPurchaseOrderFacade.Reports;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentUnitDeliveryOrderReturFacades;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentReceiptCorrectionFacades;
//using Com.Anqa.Service.Purchasing.Lib.Facades.MonitoringCentralBillReceptionFacades;
//using Com.Anqa.Service.Purchasing.Lib.Facades.MonitoringCentralBillExpenditureFacades;
//using Com.Anqa.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteReceptionFacades;
using FluentScheduler;
using Com.Anqa.Service.Warehouse.WebApi.SchedulerJobs;
using Com.Anqa.Service.Warehouse.Lib.Utilities.CacheManager;
//using Com.Anqa.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteExpenditureFacades;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentPOMasterDistributionFacades;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentReports;
...
//using Com.Anqa.Service.Purchasing.Lib.Facades.PRMasterValidationReportFacade;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentExternalPurchaseOrderFacades.Reports;
//using Com.Anqa.Service.Purchasing.Lib.Facades.GarmentSupplierBalanceDebtFacades;

namespace Com.Anqa.Service.Warehouse.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "AnqaWareHouse API", Version = "v1" });
